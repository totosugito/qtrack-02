...
const Calendar = memo(
    ({
        ...
        const [yearSelectorPanelList, setYearSelectorPanelList] = useState(
            getYearSet(defaultDateYear)
        )
        ...
        useEffect(() => {
            setDates(
                getDaysArray(
                    Number(pickedYearMonth.year),
                    Number(pickedYearMonth.month)
                )
            )
        }, [pickedYearMonth])
        const minSupportDate =
            supportDateRange.length > 0 && isValidDate(supportDateRange[0])
                ? supportDateRange[0]
                : ""
        const maxSupportDate =
            supportDateRange.length > 1 && isValidDate(supportDateRange[1])
                ? supportDateRange[1]
                : ""
            ...
            <div className={`react-minimal-datetime-range-calendar`}>
                ...
                <div className={`react-minimal-datetime-range-calendar__content`}>
                    <div className={`react-minimal-datetime-range-calendar__table`}>
                        <div className={`react-minimal-datetime-range-calendar__table-row`}>
                            {captionHtml}
                        </div>
                    </div>
                    <TransitionGroup
...
const CalendarBody = memo(
    ({
        ...
        return (
            <div className={`react-minimal-datetime-range-calendar__table slide`}>
                {content}
            </div>
        )
    }
