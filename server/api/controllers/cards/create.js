...
module.exports = {
    ...
    async fn(inputs) {
        await sails.helpers.utils.logApi(this.req.isSocket, `POST /api/lists/${inputs.listId}/cards : cards/create`)
        ...
        const values = _.pick(inputs, ['position', 'name', 'description', 'startDate', 'dueDate', 'stopwatch']);
