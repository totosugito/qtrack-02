...
module.exports = {
    ...
    async fn(inputs) {
        ...
        repositions.forEach(async ({ id, position: nextPosition }) => {
            ...
            // ***
            sails.log(`... api/helpers/lists/create-one  s.broadcast : board:${values.board.id} listUpdate`)
        });
        ...
        // ***
        sails.log(`... api/helpers/lists/create-one  s.broadcast : board:${list.boardId} listCreate`)
